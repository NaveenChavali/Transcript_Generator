...
def showw():
    ...
    Label(master, text="Degree").grid(row=2, column=0)
    Label(master, text="Major").grid(row=2, column=1)
    Label(master, text="Matric").grid(row=2, column=2)
    Label(master, text="Sex").grid(row=2, column=3)
    deg = Entry(master)
    deg.grid(row=3, column=0)
    major = Entry(master)
    major.grid(row=3, column=1)
    matric = Entry(master)
    matric.grid(row=3, column=2)
    sex = Entry(master)
    sex.grid(row=3, column=3)
    ...
    i+=1
    Label(master, text="EDU").grid(row=i, column=0)
    Label(master, text="ENG").grid(row=i, column=1)
    Label(master, text="FIN & MGT").grid(row=i, column=2)
    Label(master, text="HIS").grid(row=i, column=3)
    Label(master, text="INS & RE").grid(row=i, column=4)
    Label(master, text="LAN").grid(row=i, column=5)
    ...
    edu= Entry(master)
    edu.grid(row=i, column=0)
    eng= Entry(master)
    eng.grid(row=i, column=1)
    finnmgt= Entry(master)
    finnmgt.grid(row=i, column=2)
    his= Entry(master)
    his.grid(row=i, column=3)
    insnre= Entry(master)
    insnre.grid(row=i, column=4)
    lan= Entry(master)
    lan.grid(row=i, column=5)
    ...
    Label(master, text="SEC").grid(row=i, column=0)
    Label(master, text="SPE DRA").grid(row=i, column=1)
    Label(master, text="SOC SCI").grid(row=i, column=2)
    Label(master, text="TAX").grid(row=i, column=3)
    Label(master, text="BUS ELE").grid(row=i, column=4)
    Label(master, text="LA ELE").grid(row=i, column=5)

    i+=1

    sec.grid(row=i, column=0)
    spedra= Entry(master)
    spedra.grid(row=i, column=1)
    socsci= Entry(master)
    socsci.grid(row=i, column=2)
    tax= Entry(master)
    tax.grid(row=i, column=3)
    busele= Entry(master)
    busele.grid(row=i, column=4)
    laele= Entry(master)
    laele.grid(row=i, column=5)
